...
class ClassificationDataset(DatasetBase):
    ...
    DOC_LABEL_RELATION = "doc_label_relation"
    DOC_LABEL_GROUP = "label_group"
    ...
    def _group_label(self, is_zero=False):
        ...
        if is_zero:
            ...
            with open(file_path, mode='r') as f_in:
                ...
                label_group_dict[self.config.data.label_groups.zero] = \
                    list(set(self.label_map).difference(freq_few_labels))
