...
ClassificationDataset, ClassificationCollator, FastTextCollator,FastText, TextCNN, TextRNN, TextRCNN, DRNN, TextVDCNN
Transformer, DPCNN, AttentiveConvNet, RegionEmbedding, ZLWACNN, ZLWARNN, ZSJLCNN, ZSJLRNN
